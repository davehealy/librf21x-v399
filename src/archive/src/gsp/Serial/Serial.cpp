...
/*
 * This library is modified to fit to special use of EnjoyRF21x.
...
LONG CSerial::Setup (int eBaudrate, EDataBits eDataBits, EParity eParity, EStopBits eStopBits)
{
        // Reset error state
        m_lLastError = ERROR_SUCCESS;
